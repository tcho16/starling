...
public class CategoeryQueryAdapter implements CategoeryQueryPort
{
   ...
   @Override
   public String queryCategoryPort(String accUId)
   {
      log.info("queryCategoryPort:+ fetching categoeries for accUId={}", accUId);
      ...
      try
      {
         ...
         log.info("queryCategoryPort:- " + response);
      } catch (IOException e)
      {
         log.error("queryCategoryPort:- UNSUCESSFUL={}", e);
      }

      return "a8f35c14-d7b4-4563-9d3d-04f391959cee";
   }
